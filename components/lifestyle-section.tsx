  ...
  return (
    <section className="relative py-32 bg-[#121212] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <motion.span
            className="font-mono text-[#6BA82E] text-sm tracking-widest inline-block"
          ...
          {lifestyleImages.map((img, index) => (
            ...
            >
              ...
              >
                ...
                />
                <motion.div
                  className="absolute inset-0 bg-[#6BA82E]/0 group-hover:bg-[#6BA82E]/20"
                  initial={{ opacity: 0 }}
          ...
          {socialPosts.map((post, index) => (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <motion.div
                  className="w-10 h-10 rounded-full bg-[#6BA82E]/20 flex items-center justify-center"
                  whileHover={{ scale: 1.1, rotate: 5 }}
                  transition={{ type: "spring", stiffness: 400, damping: 17 }}
                >
                  <span className="text-[#6BA82E] font-bold text-sm">{post.handle.charAt(1).toUpperCase()}</span>
                </motion.div>
