...
import { Recycle, Sprout, Users, Package } from "lucide-react"
  ...
  return (
    <section id="impact" className="relative py-16 bg-white overflow-hidden">
      ...
      <div ref={ref} className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        >
          <motion.span
            className="inline-block font-mono text-[#6BA82E] text-[10px] tracking-[0.3em] uppercase"
          ...
          <div className="overflow-hidden mt-2">
            ...
            >
              Good For Farms & Plates
            </motion.h2>
          </div>

          {/* Animated underline */}
          <motion.div
            className="h-[2px] w-12 bg-[#6BA82E] mx-auto mt-3 rounded-full"
            initial={{ scaleX: 0 }}
