...
const instagramPosts = [
  { image: "/gallery/farm-field.png", likes: "2.4k" },
  { image: "/gallery/harvest-hands.png", likes: "1.8k" },
  { image: "/gallery/amla-fruit.png", likes: "3.2k" },
  { image: "/gallery/processing.png", likes: "956" },
  { image: "/gallery/market-stall.png", likes: "1.5k" },
  ...
  return (
    <section id="story" className="relative py-16 bg-[#121212] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <motion.span
            className="font-mono text-[#6BA82E] text-xs tracking-widest inline-block"
          ...
          {instagramPosts.map((post, index) => (
            ...
            >
              <Image
                ...
                alt={`Me & I farm-to-jar story ${index + 1}`}
                fill
                className="object-cover grayscale group-hover:grayscale-0 transition-all duration-500"
              />
              <motion.div
                className="absolute inset-0 bg-[#6BA82E]/0 group-hover:bg-[#6BA82E]/20 flex items-center justify-center"
                initial={{ opacity: 0 }}
