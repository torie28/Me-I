...
const flavors = [
  {
    ...
    description: "Slow-ground from surplus garlic bulbs. Ready-to-cook flavour with zero fillers or preservatives.",
    image: "/products/garlic-paste.png",
  ...
  },
  {
    id: 2,
    name: "Soursop Powder",
    tagline: "Tropical Boost",
    description: "Sun-dried soursop milled into a fine powder. Blend into smoothies, teas and desserts.",
    image: "/products/soursop-powder.png",
  ...
  },
  {
    ...
    description: "Nutrient-dense Indian gooseberry, dried and ground. A tart spoonful of everyday goodness.",
  ...
  },
  {
    ...
    name: "Chili Sauce",
    tagline: "Hot & Sweet",
    description: "Two takes on surplus chilies \u2014 a fiery hot sauce and a mellow sweet one. Bottled fresh.",
    image: "/products/chili-sauce.png",
...
export function FlavorCarousel() {
  ...
  return (
    <section id="products" className="relative py-16 bg-white overflow-hidden">
      <motion.div
